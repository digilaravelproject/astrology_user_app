...
class MatrimonyRegistrationScreen extends StatefulWidget {
  ...
  @override
  State<MatrimonyRegistrationScreen> createState() =>
      _MatrimonyRegistrationScreenState();
}

class _MatrimonyRegistrationScreenState
    extends State<MatrimonyRegistrationScreen> {
  ...
  void _populateFieldsForEdit(MatrimonyProfileModel profile) {
    ...
    if (profile.drivingLicenceNumber != null &&
        profile.drivingLicenceNumber!.isNotEmpty) {
    ...
    if (profile.aadhaarCardNumber != null &&
        profile.aadhaarCardNumber!.isNotEmpty) {
  ...
  final List<String> _profileForOptions = [
    AppStrings.myself,
    AppStrings.mySon,
    AppStrings.myDaughter,
    AppStrings.myBrother,
    AppStrings.mySister,
    AppStrings.myFriend,
  ...
  bool _validateCurrentStep() {
    ...
    if (_currentStep == 0) {
      if (_selectedProfileFor == null) {
        _errors['profileFor'] =
            "Please select who you are creating the profile for";
        isValid = false;
      }
      ...
      bool isDocSelected =
          _isPanSelected || _isDrivingLicenceSelected || _isAadhaarSelected;
      if (!isDocSelected) {
        _errors['documents'] =
            "Please select and provide at least one identity document";
        isValid = false;
      }
      if (_isPanSelected) {
        if (_panController.text.isEmpty) {
          ...
          r'^[A-Z]{5}[0-9]{4}[A-Z]{1}$',
        ).hasMatch(_panController.text.toUpperCase())) {
    ...
    if (_currentStep < _totalSteps - 1) {
      ...
      final profile = MatrimonyProfileModel(
        ...
        drivingLicenceNumber:
            _isDrivingLicenceSelected ? _drivingLicenceController.text : null,
        ...
        children: [
          ...
          _buildTextField(
            ...
            onChangedCustom: (val) {
              ...
              if (feet < 3 &&
                  digits.length >
                      1) {} // Optional: could limit minimum feet too
          ...
          const SizedBox(height: 16),
          _buildDropdownField(
            AppStrings.maritalStatusReq,
            _maritalStatusOptions,
            (val) => setState(() => _selectedMaritalStatus = val),
            _selectedMaritalStatus,
            errorKey: 'maritalStatus',
          ),
          const SizedBox(height: 16),
          _buildTextField(
            AppStrings.currentLocationReq,
            _locationController,
            errorKey: 'location',
          ),
          const SizedBox(height: 16),
          _buildTextField(
            AppStrings.highestEducationReq,
            _educationController,
            errorKey: 'education',
          ),
          const SizedBox(height: 16),
          _buildTextField(
            AppStrings.jobTitleReq,
            _jobTitleController,
            errorKey: 'jobTitle',
          ),
          const SizedBox(height: 16),
          _buildTextField(
            AppStrings.annualIncomeReq,
            _incomeController,
            errorKey: 'income',
          ),
          const SizedBox(height: 16),
  ...
  Widget _buildGenderChip(String gender) {
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          color:
              isSelected ? AppColors.deepPink : Colors.black.withOpacity(0.05),
          borderRadius: BorderRadius.circular(20),
          border: Border.all(
            color:
                isSelected ? Colors.transparent : Colors.black.withOpacity(0.1),
          ),
        ),
        child: AppText(
          gender,
          ...
          if (_isDrivingLicenceSelected)
            Padding(
              ...
              child: _buildTextField(
                ...
                errorKey: 'driving',
                helperText: "Example: DL-1420110012345",
              ),
            ),
          if (_isAadhaarSelected)
            Padding(
  ...
  Widget _buildTextField(
    ...
    Function(String)? onChangedCustom,
    FocusNode? focusNode,
  }) {
