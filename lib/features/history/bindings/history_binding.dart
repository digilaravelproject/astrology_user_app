...
import 'package:astro_user/features/history/controllers/history_controller.dart';
...
class HistoryBinding extends Bindings {
  ...
  void dependencies() {
    ...
    Get.lazyPut<HistoryController>(() => HistoryController(getChatSessionsUseCase: Get.find<GetChatSessionsUseCase>()));
  }
}
