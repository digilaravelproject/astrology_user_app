...
import 'package:astro_user/features/kundli/repositories/dasha_repository.dart';
...
class DashaController extends GetxController {
  ...
  Future<void> fetchDashaDetails({
    ...
    breadcrumbs.clear();
    breadcrumbs.add(DashaBreadcrumb(level: DashaLevel.mahadasha, title: "Mahadasha".tr));
