...
class _HomeScreenState extends State<HomeScreen> {
  ...
  List<String> get filters => [
    AppStrings.homeFilter,
    AppStrings.homeAll,
    AppStrings.homeFavourite,
    AppStrings.homeNew,
  ];
                    ...
                    Obx(() {
                      try {
                        ...
                        if (remedyController.remedies.isEmpty &&
                            !remedyController.isLoading.value) {
                          return const SizedBox.shrink();
                        }
                      } catch (_) {}
                      return const Column(
                        children: [SizedBox(height: 25), RemedyGrid()],
                      );
                    }),
                    Obx(() {
                      try {
            ...
            SliverToBoxAdapter(
              child: Obx(() {
                ...
                final hasActiveSessions =
                    liveController != null &&
                    liveController.activeSessions.isNotEmpty;
                return Column(
                  children: [
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
              ...
              Row(
                ...
                children: [
                  GestureDetector(
                    ...
                    child: Obx(() {
                      final bal =
                          walletController.wallet.value?.balance ?? '0.00';
          ...
          Row(
            children: [
              AppText('Hello', fontSize: 16, color: Colors.grey[700]),
          ...
          () => Row(
            children:
                filters.map((filter) {
                  ...
                  bool isSelected =
                      !isFilter && controller.selectedType.value == type;
                        ...
                        decoration: BoxDecoration(
                          ...
                          border: Border.all(
                            color:
                                isFilter || isSelected
                                    ? Colors.transparent
                                    : AppColors.deepPink.withOpacity(0.3),
                            width: 1,
                          ),
                          boxShadow: [
