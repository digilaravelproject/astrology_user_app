...
class KundliScreen extends GetView<KundliController> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Obx(() {
        ...
        return _KundliScreenContent(controller: controller);
      }),
    );
  }
}

class _KundliScreenContent extends StatefulWidget {
  final KundliController controller;

  const _KundliScreenContent({required this.controller});

  @override
  State<_KundliScreenContent> createState() => _KundliScreenContentState();
}

class _KundliScreenContentState extends State<_KundliScreenContent> with SingleTickerProviderStateMixin {
  late TabController _tabController;
  
  // Only tabs with API data available
  final List<String> _tabs = [
    ...
    // "Transit",  // No data
    "Dasha",
    // "Yogini Dasha",  // No data
    // "Ashtakvarga",  // No data
    "Planets",
    // "Divisional Chart",  // No data
    // "KP",  // No data
    // "Sade Sati",  // No data
    // "Shad Bala",  // No data
    // "Bhav Bala",  // No data
    // "Manglik Report",  // No data
    // "Varshphal",  // No data
    "Yogas",
  ];
