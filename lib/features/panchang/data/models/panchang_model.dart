...
class PanchangData {
  ...
  factory PanchangData.fromJson(Map<String, dynamic> json) {
    ...
    print('[PCB_APP] [DEBUG] PanchangData.fromJson - date: ${json['date']}');
    print('[PCB_APP] [DEBUG] PanchangData.fromJson - location: ${json['location']}');
    print('[PCB_APP] [DEBUG] PanchangData.fromJson - sunrise: ${json['sunrise']}');
