...
class AppUrls {
  ...
  static String unblockAstrologer(int id) =>
      '/api/v1/user/astrologers/$id/unblock';
  ...
  static String walletInvoice(int transactionId) =>
      '/api/v1/user/wallet/transactions/$transactionId/invoice';
  ...
  static const String updateMatrimonyProfile =
      '/api/v1/user/matrimony/update_profile';
  static const String getMatrimonyProfile = '/api/v1/user/matrimony/profiles';
  static String getMatrimonyProfileDetails(int id) =>
      '/api/v1/user/matrimony/profiles/$id';
  static String getMyMatrimonyProfileDetails(int id) =>
      '/api/v1/user/matrimony/profiles_user_id/$id';
  static String matrimonySearch(String query) =>
      '/api/v1/user/matrimony/search?q=$query';
  ...
  static const String packageActiveStatus =
      '/api/v1/user/packages/active-status';
  static const String packageSessionStart =
      '/api/v1/user/packages/session/start';
  static const String packageSessionEnd = '/api/v1/user/packages/session/end';
  static const String packageSpawnChannel =
      '/api/v1/user/packages/session/spawn-channel';
  static const String packageTerminateChannel =
      '/api/v1/user/packages/session/terminate-channel';
  static const String packageHeartbeat =
      '/api/v1/user/packages/session/heartbeat';
  static const String packageActiveBanner =
      '/api/v1/user/packages/active-banner';
  ...
  static String rejectChatSession(int sessionId) =>
      '/api/v1/chat/$sessionId/cancel';
  ...
  // Chat API Endpoints
  static String getChatMessages(int sessionId) =>
      '/api/v1/chat/$sessionId/messages';
  static String sendChatMessage(int sessionId) =>
      '/api/v1/chat/$sessionId/message';
  static String markChatRead(int sessionId) => '/api/v1/chat/$sessionId/read';
  static String syncChatStatus(int sessionId) =>
      '/api/v1/chat/$sessionId/sync-status';
  ...
  static String sendIceCandidate(int sessionId) =>
      '/api/v1/call/$sessionId/ice-candidate';
  ...
  static const String astrologerCallSessions =
      '/api/v1/call/sessions/astrologer';
  ...
  static const String initiateChatAssistance =
      '/api/v1/chat-assistance/initiate';
  static const String chatAssistanceSessions =
      '/api/v1/chat-assistance/sessions';
  static String getChatAssistanceMessages(int sessionId) =>
      '/api/v1/chat-assistance/$sessionId/messages';
  static String sendChatAssistanceMessage(int sessionId) =>
      '/api/v1/chat-assistance/$sessionId/message';
  static String syncChatAssistanceStatus(int sessionId) =>
      '/api/v1/chat-assistance/$sessionId/sync-status';
  static const String getAstrologerChatAssistanceStatus =
      '/api/v1/chat-assistance/astrologer/status';
