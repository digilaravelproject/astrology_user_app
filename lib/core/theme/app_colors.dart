...
class AppColors {
  ...
  static const Color darkCardColor = Color(
    0xFF2F201E,
  ); // Slightly lighter warm dark color for cards
  static const Color darkScaffoldBackgroundColor = Color(
    0xFF1E1210,
  ); // Dark background

  static const Color darkTextColorPrimary = Color(
    0xFFFFEAE6,
  ); // Light peach text
  static const Color darkTextColorSecondary = Color(
    0xFFD2BCAE,
  ); // Muted warm text
