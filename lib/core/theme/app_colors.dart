...
class AppColors {
  // Light theme colors
  static const Color primaryColor = Color(0xFFFF9933); // Bhagwa (Saffron)
  static const Color secondaryColor = Color(0xFFFFCC33); // Light Saffron
  ...
  // Dark theme colors
  static const Color darkPrimaryColor = Color(0xFFFFB366); // Light Saffron for dark mode
